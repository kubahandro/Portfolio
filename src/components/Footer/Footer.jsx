...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=100042179494834&sk=about',
      icon: (props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/kubahandro',
      icon: (props) => (
        <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
          <path
            fillRule='evenodd'
          ...
          <div className='flex justify-center lg:justify-start '>
            <div className='flex gap-[20px] '>
              ...
              <a
                ...
                className='text-titleColor text-h5Size transition-all duration-75 ease-[cubic-bezier(0.3,0,0.3,1)] hover:text-primaryColor '
              >
                <FaLinkedin className='text-titleColor dark:text-titleColorDark hover:text-primaryColor dark:hover:text-primaryColor' />
              </a>
